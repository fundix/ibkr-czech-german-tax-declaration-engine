...
from src.countries.registry import available_countries

def parse_arguments():
    """Parses command line arguments for the application."""
    parser = argparse.ArgumentParser(description="IBKR Tax Declaration Engine")

    # Country selection
    parser.add_argument(
        "--country",
        default=getattr(config, "COUNTRY", "de"),
